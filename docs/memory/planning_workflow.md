...
This document outlines the mandatory planning workflow to be followed for all development tasks in this project.
...
- Suggest solutions that the user didn't think about, i.e. anticipate needs and things to be specified.
...
### WEB USE
- Can use the web if needed using appropriate tools (e.g., web search).
...
d. Repeat the process refining and integrating different solutions into one until a strong solution is found.
d. Can use web research if needed.
...
- Restate the user's query in your own words if necessary after giving the solution.
